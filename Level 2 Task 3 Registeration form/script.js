...
function data(){
    ...
    id.innerHTML="Reg. ID: "+element[1].value;
    ...
    if(element[5].checked && element[6].checked){skills.innerHTML="Skills: HTML, ReactJS";}
    if(element[5].checked && element[7].checked){skills.innerHTML="Skills: HTML, C++";}
    if(element[6].checked && element[7].checked){skills.innerHTML="Skills: ReactJS, C++";}
    if(element[5].checked && element[6].checked && element[7].checked){skills.innerHTML="Skills: HTML, ReactJS, C++";}
